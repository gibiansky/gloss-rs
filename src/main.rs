...
mod gloss_core;
mod extrude_thickline;

fn main() {
    let mut window = gloss_core::GlossWindow::new(400, 400, "Gloss Demo", Color::Black);
    let mut picture = Pictures(vec![
                               Colored(Color::Blue, box Polygon(vec![point(-200.0, -200.0), point(200.0, -200.0), point(200.0, 200.0), point(-200.0, 200.0)])),
                               ...
                               Colored(Color::White, box ThickCircle(150.0, 10.0)),
                               Colored(Color::White, box ThickArc(0.0, 180.0, 300.0, 20.0)),
                               ]);
